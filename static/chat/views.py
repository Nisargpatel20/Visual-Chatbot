...
def chat_view(request):
    ...
    GOOGLE_PROJECT_ID = "vision-chatboat-abxh"
    ...
    if request.content_type == 'application/json':
        ...
        file_name = upload_blob('cloud-vision-pictures', request.FILES['file'], request.FILES['file'].name)
    ...
    response = detect_intent_with_parameters(
        project_id='vision-chatboat-abxh',
